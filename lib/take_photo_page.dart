...
class _TakePhotoPageState extends State {
  ...
  _onNextClick() {
    ...
    FirebaseAuth.instance.signInAnonymously().then((user) async {
      // Store as UserId
      final StorageReference storageRef =
          FirebaseStorage.instance.ref().child(user.uid.toString());
      await storageRef.putFile(File(imagePath)).onComplete;

      final task = CreateMatchMakingProfileTask(
